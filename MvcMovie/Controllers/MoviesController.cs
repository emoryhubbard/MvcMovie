...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        public async Task<IActionResult> Index(string movieGenre, string searchString, string sortColumn) {
            ...
            if (!string.IsNullOrEmpty(movieGenre)) {
                movies = (IOrderedQueryable<Movie>) movies.Where(x => x.Genre == movieGenre);
            }
